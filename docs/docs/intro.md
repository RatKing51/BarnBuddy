...
<div className="card-grid">
  <div className="doc-card">
    <h3>Set up</h3>
    <p>Create an account, open the dashboard, make herds, and add animals.</p>
  </div>
  <div className="doc-card">
    <h3>Track care</h3>
  ...
  <div className="doc-card">
    ...
    <p>Update preferences, review billing, manage herds, or delete an account.</p>
  </div>
</div>
